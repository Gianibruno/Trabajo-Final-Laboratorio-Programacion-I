 ...
 * @author Pablo
 */
public class LectoresMultas extends javax.swing.JInternalFrame {

    /**
     * Creates new form LectoresMultas
     */
    public LectoresMultas() {
        initComponents();
        iniciar();
    }
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Buscar Lectores con multas");

        jLabel1.setFont(new java.awt.Font("Dialog", 1, 18)); // NOI18N
        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel1.setText("Lectores que poseen multa");
    ...
    private void actualizar() {
        ...
        lista = lData.obtenerLectoresConMulta();
        if(lista.size() > 0){
